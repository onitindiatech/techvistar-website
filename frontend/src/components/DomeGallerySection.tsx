...
export const TECHVISTAR_ECOSYSTEM_TILES = [
  {
    ...
    icon: 'instrex',
    title: 'INSTREX',
    description: 'Trusted partner — strategic instrumentation and tooling solutions.',
  },
  {
    type: 'icon',
    icon: 'cloudcost',
    title: 'CloudCost',
    description: 'Trusted partner — cloud cost intelligence and FinOps platform.',
  },
  {
    type: 'icon',
    icon: 'arikap',
    title: 'Arikap',
    description: 'Trusted partner — enterprise architecture and platform consulting.',
  },
  {
    type: 'icon',
    icon: 'ambikhub',
    title: 'Ambik Hub',
    description: 'Trusted partner — innovation hub for digital product acceleration.',
  },
  {
    type: 'icon',
    icon: 'clonevox',
    title: 'Clone Vox',
    description: 'Trusted partner — AI voice and audio cloning platform.',
  },
  {
    type: 'icon',
    icon: 'arikap',
