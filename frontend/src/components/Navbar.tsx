            ...
            <div className="container-custom py-4 md:py-6 px-4 md:px-5 space-y-4 md:space-y-6">
              ...
              <div className="pt-4">
                <CmsHref href={ctaLink} onClick={() => setIsMobileMenuOpen(false)}>
                  <button className="inline-flex items-center justify-center gap-2 w-full h-11 px-5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-sm font-semibold tracking-tight shadow-[0_1px_2px_rgba(14,165,233,0.2),0_4px_12px_-2px_rgba(14,165,233,0.35)] transition-colors duration-200">
                    <span>{ctaText}</span>
