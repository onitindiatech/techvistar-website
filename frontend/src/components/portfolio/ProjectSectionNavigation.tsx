...
export const ProjectSectionNavigation = ({ navItems }: ProjectSectionNavigationProps) => {
  ...
  useEffect(() => {
    ...
    const observerOptions = {
      root: null,
      rootMargin: `-${primaryHeight + subnavH + 12}px 0px -60% 0px`,
      threshold: 0,
    };
  ...
  return (
    <nav
      ref={subnavRef}
      className="sticky z-40 bg-white/95 backdrop-blur border-b border-slate-200 shadow-sm w-full transition-all duration-300"
