      ...
      <div className="relative space-y-6 overflow-hidden rounded-3xl border-2 border-emerald-500/20 bg-white p-6 shadow-sm">
        ...
        <div className="space-y-5">
          <div className="flex items-start gap-4 text-xs md:text-sm">
            ...
            <div>
              <p className="text-sm md:text-base font-bold text-slate-900">Average Response Time</p>
              <p className="mt-0.5 text-xs md:text-sm text-slate-600 font-medium">&lt; 4 Hours (Within Business Days)</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 text-xs md:text-sm">
            ...
            <div>
              <p className="text-sm md:text-base font-bold text-slate-900">Business Hours</p>
              <p className="mt-0.5 text-xs md:text-sm text-slate-600 font-medium">Monday – Friday, 9:00 AM – 6:00 PM</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 text-xs md:text-sm">
            ...
            <div>
              <p className="text-sm md:text-base font-bold text-slate-900">Secure Consultation</p>
              <p className="mt-0.5 text-xs md:text-sm text-slate-600 font-medium">All SOW outlines and documentation covered by NDA.</p>
            </div>
          </div>
        </div>
