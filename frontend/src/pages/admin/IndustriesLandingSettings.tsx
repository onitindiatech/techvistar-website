...
const IndustriesLandingSettings = () => {
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <PageHeader title="Industries Landing CMS" description="Manage Industries listing page hero, intro, CTA, and SEO." />
      ...
      <CmsSectionCard title="SEO">
        <SeoManager value={seoFromItem(form as unknown as Record<string, unknown>)} onChange={(seo) => setForm((prev) => ({ ...prev, ...seo }))} pathPrefix="/industries" defaultTitle={form.seoTitle || ''} defaultDescription={form.seoDescription || ''} defaultImage={form.hero.backgroundImage} />
      </CmsSectionCard>
