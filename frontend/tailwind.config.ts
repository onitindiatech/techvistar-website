  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'label': ['0.75rem', { lineHeight: '1.3', letterSpacing: '0.18em', fontWeight: '800' }],
        'button': ['0.9375rem', { lineHeight: '1.25', letterSpacing: '0.01em', fontWeight: '700' }],
        'nav': ['1rem', { lineHeight: '1.4', letterSpacing: '0.01em', fontWeight: '700' }],
        'mega': ['0.9375rem', { lineHeight: '1.25', letterSpacing: '0', fontWeight: '700' }],
        'mega-desc': ['0.75rem', { lineHeight: '1.45', letterSpacing: '0', fontWeight: '500' }],
      },
      letterSpacing: {
